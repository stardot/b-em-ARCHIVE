...
static inline void setadc16(uint16_t a, uint16_t b)
{
	...
	af.b.l = (((a ^ r ^ b) >> 8) & H_FLAG) | ((r >> 16) & C_FLAG) |
		 ((r >> 8) & (N_FLAG | 0x28)) | ((r & 0xffff) ? 0 : Z_FLAG) |
...
static inline void setsbc16(uint16_t a, uint16_t b)
{
	...
	af.b.l = (((a ^ r ^ b) >> 8) & H_FLAG) | S_FLAG | ((r >> 16) & C_FLAG) |
		 ((r >> 8) & (N_FLAG | 0x28)) | ((r & 0xffff) ? 0 : Z_FLAG) |
		 (((b ^ a) & (a ^ r) & 0x8000) >> 13);
}
